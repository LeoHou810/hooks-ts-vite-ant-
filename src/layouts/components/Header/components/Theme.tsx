...
const Theme = (props: any) => {
	...
	const setWeakOrGray = (checked: boolean, theme: string) => {
		if (checked) return dispatch(update("global", "themeConfig.weakOrGray", theme));
		dispatch(update("global", "themeConfig.weakOrGray", ""));
	};

	const onChange = (checked: boolean, keyName: string) => {
		return dispatch(update("global", `themeConfig.${keyName}`, !checked));
	};
